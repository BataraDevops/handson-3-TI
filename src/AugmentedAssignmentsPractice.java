public class AugmentedAssignmentsPractice {
    public static void main(String[] args) {
        ...
        value1 = value1 + 30;
        value2 += 30;
        System.out.println("Nilai value1 = " + value1 + " Nilai value2 = " + value2);
        ...
        value2 *= 3;
        // - Print kedua nilai untuk memastikan keduanya sama
        System.out.println("Nilai value1 (regular)= " + value1 + " Nilai value2 (augmented)= " + value2);
        ...
        System.out.println("suhu Akhir dalam fahrenheit = " + temperature + "F");
        ...
        System.out.println("Nilai investasi : " + investment);
