public class ExpressionPractice {
    public static void main(String[] args) {
        ...
        System.out.println("Hasil dari " + a + " + " + b + " = " + sum);
        System.out.println("Hasil dari " + a + " x " + b + " = " + product);
        System.out.println("apakah "+ a + " > " + b + " = " + lebihBesar);
        System.out.println("hasil dari 'Hello' + 'World' =  " + helloWorld);
        System.out.println("Hasil dari 2^3 = " + mathPow);
        ...
        if (x > 10){
            ...
            System.out.print(x);
            System.out.println(" masuk category " + category);
        }
        ...
        System.out.println("nilai outerVariable setelah block = " + outerVariable);
        // - Coba print innerVariable di sini - apa yang terjadi? (Comment baris ini setelah testing)
        //System.out.println("print innerVariable diluar block = " + innerVariable); // error
    }
}
